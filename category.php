...
$sort_key = $_GET['sort'] ?? 'popularity'; // Initialize sort key here
...
try {
    ...
    if ($category['parent_id'] === null) { // It's a main category, get its children too
    ...
    if (!empty($category_ids_to_query)) {
        // --- 3. Build Dynamic SQL WHERE Clauses ---
        $params = [];
        ...
        // --- 4. Get Filter Options (Brands & Price Range) ---
    ...
    <div class="row">
                ...
                <form method="GET" id="filter-form" action="/category/<?php echo e($slug); ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="form-check">
                            <input class="form-check-input brand-checkbox" type="checkbox" name="brands[]" value="<?php echo e($brand['id']); ?>" id="brand-<?php echo e($brand['id']); ?>" <?php echo in_array($brand['id'], $brands_filter) ? 'checked' : ''; ?>>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="rating-filter d-flex flex-row-reverse justify-content-end">
                            <?php for ($i = 5; $i >= 1; $i--): ?>
                            <input type="radio" id="star<?php echo $i; ?>" name="min_rating" value="<?php echo $i; ?>" class="d-none rating-radio" <?php echo ($min_rating == $i) ? 'checked' : ''; ?>>
                            <label for="star<?php echo $i; ?>" class="rating-star fs-4" title="<?php echo $i; ?> star & up">★</label>
                            <?php endfor; ?>
                        </div>
                    </div>
        ...
        <main class="col-lg-9">
            <div class="p-3 bg-white rounded shadow-sm mb-4">
                ...
                <p class="text-muted mb-0">Showing <?php echo count($products); ?> of <?php echo $total_products; ?> products</p>
            </div>
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4">
                <?php if (!empty($products)):
                    ...
                    echo '<div class="col-12"><div class="alert alert-info text-center p-5">No products found in this category. Please try adjusting the filters or check back later.</div></div>';
                endif; ?>
            </div>
