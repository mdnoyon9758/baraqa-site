...
<div class="container my-4 product-page-amazon">
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-2">
            ...
            <div class="vertical-thumbnail-gallery">
                <?php foreach ($gallery_images as $index => $img_url): ?>
                    <div class="vertical-thumbnail-item mb-2">
        ...
        <!-- Right Column: Product Details and Buy Box -->
        <div class="col-lg-6">
            <div class="row">
                <div class="col-12">
                    ...
                    <!-- Buy Box -->
                    <div class="card buy-box-amazon p-3 mb-3">
                        <div class="card-body">
